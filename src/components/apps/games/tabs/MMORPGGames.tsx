...
const mmorpgGames = [
  { name: "MMORPG Game1", image: "/assets/game-imgs/mmorpg-game1.png", description: "Description for MMORPG Game1", url: "URL_FOR_MMORPG_GAME1" },
  { name: "MMORPG Game2", image: "/assets/game-imgs/mmorpg-game2.png", description: "Description for MMORPG Game2", url: "URL_FOR_MMORPG_GAME2" },
  { name: "MMORPG Game3", image: "/assets/game-imgs/mmorpg-game3.png", description: "Description for MMORPG Game3", url: "URL_FOR_MMORPG_GAME3" }
];
